...
public class Goal3_yb extends YBMicroBenchmark {

    private static final Logger LOG = LoggerFactory.getLogger(Goal3_yb.class);
    ...
    public Goal3_yb(HierarchicalConfiguration<ImmutableNode> config) {
        super(config);
