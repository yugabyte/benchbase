...
public class YBMicroBenchmarkWriteImpactWithExtraIndex0 extends YBMicroBenchmark {
    ...
    public YBMicroBenchmarkWriteImpactWithExtraIndex0(HierarchicalConfiguration<ImmutableNode> config) {
        super(config);
