...
//                stringer.key(clazz.getSimpleName());
                com.oltpbenchmark.benchmarks.featurebench.utils.JSONUtil.writeFieldValue(stringer, clazz, object);
            }
    ...
    public static <T extends JSONSerializable> void load(T object, String input_path) throws IOException {
        ...
        try (InputStream in = com.oltpbenchmark.benchmarks.featurebench.utils.JSONUtil.class.getResourceAsStream(input_path)) {
    ...
    protected static void readMapField(final JSONObject json_object, final Map map, final Stack<Class> inner_classes) throws Exception {
        ...
        for (String json_key : CollectionUtil.iterable(json_object.keys())) {
            ...
            // KEY
            Object key = com.oltpbenchmark.benchmarks.featurebench.utils.JSONUtil.getPrimitiveValue(json_key, key_class);
            ...
            if (json_object.isNull(json_key)) {
                ...
                object = com.oltpbenchmark.benchmarks.featurebench.utils.JSONUtil.getPrimitiveValue(json_string, val_class);
    ...
    protected static void readCollectionField(final JSONArray json_array, final Collection collection, final Stack<Class> inner_classes) throws Exception {
        ...
        for (int i = 0, cnt = json_array.length(); i < cnt; i++) {
            ...
            if (json_array.isNull(i)) {
                ...
                value = com.oltpbenchmark.benchmarks.featurebench.utils.JSONUtil.getPrimitiveValue(json_string, inner_class);
            }
    ...
    public static void readFieldValue(final JSONObject json_object, final String json_key, Field field_handle, Object object) throws Exception {
        ...
        if (json_object.isNull(json_key)) {
            ...
            Class explicit_field_class = com.oltpbenchmark.benchmarks.featurebench.utils.JSONUtil.getClassForField(json_object, json_key);
            ...
            Object value = com.oltpbenchmark.benchmarks.featurebench.utils.JSONUtil.getPrimitiveValue(json_object.getString(json_key), field_class);
