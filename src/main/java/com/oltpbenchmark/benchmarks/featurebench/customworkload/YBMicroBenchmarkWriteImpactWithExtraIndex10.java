...
public class YBMicroBenchmarkWriteImpactWithExtraIndex10 extends YBMicroBenchmark {
    ...
    public YBMicroBenchmarkWriteImpactWithExtraIndex10(HierarchicalConfiguration<ImmutableNode> config) {
        super(config);
